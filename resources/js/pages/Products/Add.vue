...
-->
              ...
              <div class="w-full">
                <div
                  ...
                  v-for="(item, index) in form.variants"
                >
                  <Input
                    label-name="Weight"
                  ...
                  <button
                    class="p-1 rounded-lg bg-primary text-white"
                    v-if="index === 0"
                    @click="addRow"
                  >
                  ...
                  <button
                    class="p-1 rounded-lg bg-red-800 text-white"
                    v-else
          ...
          <div class="w-full flex items-center space-x-5 px-2 mt-2">
            <div class="w-full">
              ...
              <small
                class="text-red-500"
                v-if="error?.response?.data?.errors?.category_id"
              >
          ...
          <div class="w-full px-2">
            ...
            <textarea
              ...
              v-model="form.about"
              :disabled="loading"
              class="p-1 border disabled:bg-gray-200 border-primary w-full rounded focus:ring-0 focus:border-primary"
            ></textarea>

            <small
              class="text-red-500"
              v-if="error?.response?.data?.errors?.about"
            >
        ...
        <div class="w-1/2 flex flex-col gap-4 px-2">
          <div class="flex">
            <div class="pr-2">
              ...
              <small
                class="text-red-500"
                v-if="error?.response?.data?.errors?.cover_image"
              >
        ...
        <div class="w-1/2 px-2 mb-5">
          ...
          <div class="editor_data">
            ...
            <small
              class="text-red-500"
              v-if="error?.response?.data?.errors?.details"
            >
        ...
        <div class="w-1/2 flex flex-col gap-3 px-2">
          <div class="w-full px-2">
            <Input
              label-name="Video Url"
              v-model="form.video_url"
              label="Video Url"
              :error="error?.response?.data?.errors?.video_url"
              :loading="loading"
              required
            />
          </div>
    ...
    <div class="text-center pt-10">
      <LoadingButton @click="onSubmit" :isLoading="loading" class="!w-1/2"
        >Save Product</LoadingButton
      >
    </div>
  </AppLayout>
</template>
