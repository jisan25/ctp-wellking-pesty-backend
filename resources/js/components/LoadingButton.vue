<template xmlns="http://www.w3.org/1999/html">
    <button :disabled="isLoading" :class="isLoading ? 'animate-pulse' : ''" class=" my-3 bg-primary w-full text-white rounded-md px-3 py-2  hover:bg-secondary transition-all disabled:bg-primary/50 ease-in-out duration-500">
        <span v-if="!isLoading">
            <slot></slot>
        </span>
