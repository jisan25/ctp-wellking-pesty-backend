...
class CustomerController extends Controller
{
    ...
    public function dashboardData()
    {
            ...
            SUM(CASE WHEN order_status != "delivered" AND order_status != "cancel" THEN 1 ELSE 0 END) as pending_orders')->first();
...
//            ]);
    ...
    public function sendForgotPasswordReqs(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        if($isMailSetup){
            ...
            return \response()->json('Email Server Credentials Not Setuped...!', 404);
        }
    }
